...
public class Algorithms_AC {
    ...
    public Algorithms_AC(String typeOfAlgorithm, ArrayList<PConstraint> constraintList,
        ...
        System.out.println(mainFunctions.check(variables.get(0), 1, variables.get(1), 3));
    }
